...
using(easyloader.defaultReferenceModules, function () {
    ...
    var dataGridOptions = {
        columns: [[
            ...
            { field: 'YearNo', title: '年度', width: 80, sortable: true },
            { field: 'CourseType', title: '课程类型', width: 80, sortable: true },
        ...
        loader: function (param, success, error) {
            var studentData = {
                ...
                order: param.order,
                sort: param.sort,
                courseStudentTempBo: { userId: $.cookie('UserId') },
                userId: $.cookie('UserId')
            };
            var paramStr = JSON.stringify(studentData);

            ajaxCRUD({
                url: '/WebServices/Course/CourseWebServices.asmx/GetCourseStudentSingle',
                data: paramStr,
