...
function saveDataChangeUserPsw() {
    ...
    if ($('#txtPassword').val() != '') {
        var basicUrl = '/WebServices/CommonWebService/UserWebService.asmx/';
        var wsMethod = '';
        ...
        var jsonDataStr = "{pVipUserBo:" + form2JsonStr + "}";
        ...
        ajaxCRUD({
            ...
            success: function (data) {
                if (data == 1) {
                    $.messager.alert('提示', '修改密码成功', 'info', function () { closeParentTab(); });
                }
