    ...
    var dataGridOptions = {
        ...
        columns: [[
            { field: 'CriId', checkbox: true },
             {field: 'StartCity', title: "出发城市", width: 60 },
            { field: 'EndCity', title: "目的城市", width: 60 },
            { field: 'StartArea', title: "出发区域", width: 100 },
            { field: 'EndArea', title: "目的区域", width: 100 },
            { field: 'StationName', title: '所属站点', width: 80 },
            { field: 'Type', title: '车型', width: 60 },
//            { field: 'AllowanceRMB', title: "津贴(RMB)", width: 70 },
//            { field: 'AllowanceHKD', title: "津贴(HKD)", width: 70 },
            { field: 'GuestPriceRMB', title: "直客价(RMB)", width: 80 },
            { field: 'GuestPriceHKD', title: "直客价(HKD)", width: 80 },
            { field: 'VipPriceRMB', title: "会员价(RMB)", width: 80 },
            { field: 'VipPriceHKD', title: "会员价(HKD)", width: 80 },
            { field: 'AgentPriceRMB', title: "代理价(RMB)", width: 80 },
            { field: 'AgentPriceHKD', title: "代理价(HKD)", width: 80 },
            { field: 'IsHotStr', title: "热门线路", width: 55 }
        ]],
        singleSelect: true,
        toolbar: '#toolbar',
        sortName: 'CriId',
...
function openAdvancedSearch() {
    ...
    if (eastPanel.length == 0) {
        var options = {
            ...
            closable: true,
            title: '高级搜索',
            href: '/View/Carrental/CarrentalRoute/CarrentalRouteAdvancedSearch.htm',
            onLoad: function () {
