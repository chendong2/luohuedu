...
commoncitys[1] = new Array('ZUH', '珠海', 'ZHUHAI', 'ZH');

commoncitys[2] = new Array('DNG', '东莞', 'DONGGUAN', 'DD');
 
commoncitys[3] = new Array('CAN','广州','GUANGZHOU','GZ');

commoncitys[4] = new Array('ZSO', '中山', 'ZHONGSHAN', 'ZS');

commoncitys[5] = new Array('FOH', '佛山', 'FUSHAN', 'FS');

commoncitys[6] = new Array('HUI', '惠州', 'HUIZHOU', 'HZ');

commoncitys[7] = new Array('JMO', '江门', 'JIANGMEN', 'JM');

commoncitys[8] = new Array('HKG', '香港', 'XIANGGANG', 'XG');

commoncitys[9] = new Array('XMN', '厦门', 'XIAMEN', 'XM');

commoncitys[10] = new Array('SSH', '石狮', 'SHISHI', 'SS');

commoncitys[11] = new Array('YGC', '永春', 'YONGCHUN', 'YC');

commoncitys[12] = new Array('SHD', '顺德', 'SHUNDE', 'SD');

commoncitys[13] = new Array('SIH', '四会', 'SIHUI', 'SIH');

commoncitys[14] = new Array('KAP', '开平', 'KAIPING', 'KP');
//初始化所有国内机场城市
var citys=new Array();
// A
...
citys[157] = new Array('HKG', '香港', 'XIANGGANG', 'XG');

citys[158] = new Array('DNG', '东莞', 'DONGGUAN', 'DD');

citys[159] = new Array('ZSO', '中山', 'ZHONGSHAN', 'ZS');

citys[160] = new Array('FOH', '佛山', 'FUSHAN', 'FS');

citys[161] = new Array('HUI', '惠州', 'HUIZHOU', 'HZ');

citys[162] = new Array('JMO', '江门', 'JIANGMEN', 'JM');

citys[163] = new Array('SSH', '石狮', 'SHISHI', 'SS');

citys[164] = new Array('YGC', '永春', 'YONGCHUN', 'YC');

citys[165] = new Array('TAS', '台山', 'TAISHAN', 'TS');

citys[166] = new Array('HEY', '河源', 'HEYUAN', 'HY');

citys[167] = new Array('ENP', '恩平', 'ENPING', 'EP');

citys[168] = new Array('SDE', '順德', 'SHUNDE', 'SD');

citys[169] = new Array('HES', '鹤山', 'HESHAN', 'HS');

citys[170] = new Array('ZQG', '肇庆', 'ZHAOQING', 'ZQ');