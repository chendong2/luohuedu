...
namespace Domain.common
{
    public class ObjectId
    {
        ...
        public override string ToString()
        {
            ...
            //var a = long.Parse(_string, System.Globalization.NumberStyles.HexNumber).ToString();
            return _string;
        }
        ...
        public static string StrRep(string strold, string chr, string newstr)
        {
            StringBuilder sb = new StringBuilder(strold);
            return sb.Replace(chr, newstr).ToString();
